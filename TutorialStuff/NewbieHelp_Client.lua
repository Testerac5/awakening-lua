...
{"Interface\\AddOns\\AwAddons\\Textures\\Tutorial\\tutorial_TexUpgrades","|cffFFFFFFOn Ascension, you have a lot of |rcustom|cffFFFFFF features with easy access to them trough our custom User Interface. You may get access to them using our special |rCharacter Upgrades|cffFFFFFF panel on your |rMain Menu Bar|cffFFFFFF on trough |rquick access|cffFFFFFF frame on your screen.|r"},
...
{"Interface\\AddOns\\AwAddons\\Textures\\Tutorial\\tutorial_TexFreeReset","|cffFFFFFFNeed a |rchange|cffFFFFFF? We’re here to help! Up until level 10 we have |rfree spell resets|cffFFFFFF to ensure you can play around with our system and feel what is right for you. This won’t always be the case though. After level 10 make sure to think about your choices as you will have to use currency to mix things up again.|r"},
