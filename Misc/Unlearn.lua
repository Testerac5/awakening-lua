local function UnlearnHello(event, player, creature)
	player:GossipMenuAddItem(0, "Alchemy", 900017, 1)
	player:GossipMenuAddItem(0, "Blacksmithing", 900017, 2)
	player:GossipMenuAddItem(0, "Enchanting", 900017, 3)
	player:GossipMenuAddItem(0, "Engineering", 900017, 4)
	player:GossipMenuAddItem(0, "Herbalism", 900017, 5)
	player:GossipMenuAddItem(0, "Leatherworking", 900017, 6)
	player:GossipMenuAddItem(0, "Mining", 900017, 7)
	player:GossipMenuAddItem(0, "Skinning", 900017, 8)
	player:GossipMenuAddItem(0, "Tailoring", 900017, 9)
