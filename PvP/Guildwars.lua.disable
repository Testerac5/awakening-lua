...
local SERVER_PRE_MESSAGE = "[Guild Wars]";
...
-- ****************************************************
	...
	if(player:IsInGuild()==true)then
		...
		if(ChatCache[1] == GWCOMM[PLAYER_GUILD_ID].commands)then
			...
			player:SendBroadcastMessage(GWCOMM[PLAYER_GUILD_ID].color_8.."*  -Guild Wars Commands:-  *");
			player:SendBroadcastMessage(GWCOMM[PLAYER_GUILD_ID].color_9.."*********************************************");
		...
		if(ChatCache[1]==GWCOMM[PLAYER_GUILD_ID].version)then
			...
			player:SendBroadcastMessage(GWCOMM[PLAYER_GUILD_ID].color_1.."Guild Wars. VER : "..GW_version.."|r");
