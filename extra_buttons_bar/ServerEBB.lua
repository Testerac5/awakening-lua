...
function MyHandlers.ResetSpells(player)
	...
	if (player:InArena() ==	true or player:InBattleground() == 	true) then
		...
		if (player:HasItem(spell_reset_token) == true or free_spell_reset == true) then		 
			...
			local noTEspells = {54785, 50589, 50581, 59671, 11417, 11420, 11418, 3567, 3566, 3563, 11419, 11416, 10059, 3565, 3562, 3561, 21849, 21850, 26991, 48470, 21562, 21564, 25782, 25916, 27141, 27681, 49360, 49359, 49361, 49358, 10143}
