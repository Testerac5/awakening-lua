   ...
   local sideBar_CloseButton = CreateFrame("Button", "sideBar_CloseButton", sideBar, "UIPanelCloseButton")
    ...
    --[[TRAINING FRAME]]--
     local TrainingFrame = CreateFrame("Frame", "TrainingFrame", UIParent, nil)
        ...
        font_TrainingFrame_SelectedTitle_Spells:SetPoint("CENTER", TrainingFrame_SelectedTitle, "CENTER", 0, -200)
        ...
        font_TrainingFrame_SelectedTitle_Talents:SetPoint("CENTER", TrainingFrame_SelectedTitle, "CENTER", 0, -200)
